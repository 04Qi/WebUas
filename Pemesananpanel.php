...
<head>
    ...
    <title>Pemesanan Panel Mini</title>
    <style>
        body {
...
<body>
    ...
    <form action="process_order.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" id="hargaSatuan" name="hargaSatuan" value="100000" readonly>
        </div>

        <div class="detail-harga">
            <h3>Detail Harga</h3>
            <p>Harga Satuan: Rp <span id="displayHargaSatuan">100.000</span></p>
            <p>Jumlah: <span id="displayJumlah">1</span></p>
            <p>Total: Rp <span id="displayTotal">100.000</span></p>
        </div>
