        ...
        <div class="main">
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    <div class="mb-3">
                        <h3 class="fw-bold fs-4 mb-3">Data Admin</h3>
                        <div class="mb-3">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_admin.php?id=<?php echo $row['id']?>" class="btn btn-primary btn-sm"><i class='bx bxs-edit'></i></a>
                                                <a href="hapus_admin.php?id=<?php echo $row['id']?>" onClick="return confirm('Anda yakin akan menghapus data ini?')" class="btn btn-danger btn-sm"><i class='bx bx-trash-alt' ></i></a>
                                            </td>
